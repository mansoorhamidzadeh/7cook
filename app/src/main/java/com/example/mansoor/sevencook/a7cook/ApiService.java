...
public class ApiService {
    ...
    public void getRecipec(Response.Listener<List <Recipe>> reciplistListener) {
    ...
    public void getBanners(Response.Listener<List<Banner>> bannerlistListener) {
    ...
    public void getCategories(Response.Listener<List<Category>> categoryListener ) {
      ...
      /*  GsonRequest<Category> recipeGsonRequest=new GsonRequest<>(
                Request.Method.GET,
                "https://api.myjson.com/bins/v0bog",
                Category.class,
